...
%%Purpose: Simulates mean field equations for SNIPER model and creates 
%%plot of magnitude of order parameter vs. time
...
%%Function to determine rate of change of order parameter.
